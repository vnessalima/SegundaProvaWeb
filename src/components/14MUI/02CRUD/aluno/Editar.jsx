...
const Editar = () => {
    ...
    useEffect( 
        ()=>{
            axios.get(`http://localhost:3001/aluno/retrieve/${id}`) //local da web onde o produto final se encontra
            .then(
                (response)=>{
    ...
    function handleSubmit(event) {
        ...
        axios.put(`http://localhost:3001/aluno/update/${id}`,professorAtualizado) //constante que vai att o professor
        .then(
            (response)=>{
