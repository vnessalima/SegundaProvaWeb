...
const StyledTableCell = styled(TableCell)(({ theme }) => ({ 
  [`&.${tableCellClasses.head}`]: {
    backgroundColor: theme.palette.common.black, //faz o fundo preto do background
...
const Aprovados = () => {  //constante que guarda os alunos e as medias deles 
  const [alunos, setAlunos] = useState([]);
  const [mudou, setMudou] = useState(false);
  const [media, setMedia] = useState(0);

  useEffect(() => {
    //o resultado é tirado atraves da propriedade data e armazenado no estado "media" da função
    axios
